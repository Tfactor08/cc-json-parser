"""Produce AST using tokens generated by the lexer"""
...
def parse_attribute() -> Attribute:
    ...
    if label.literal_type != LiteralType.Str:
        error(f"Object attribute name must be a string\nFound: {prev}")
...
def parse_literal() -> Literal:
    ...
    match token.ttype:
        ...
        case _:
            error(f"Unexpected token found during parsing: {at()}")
            exit(1)
